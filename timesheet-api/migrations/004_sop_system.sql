...
-- 6. 初始分類資料
-- ============================================================
INSERT INTO sop_categories (name, parent_id, sort_order, description, icon) VALUES
  ('記帳作業', NULL, 1, '記帳相關標準作業程序', 'book'),
  ('報稅作業', NULL, 2, '報稅相關標準作業程序', 'description'),
  ('登記作業', NULL, 3, '公司登記相關程序', 'business'),
  ('審計作業', NULL, 4, '審計相關程序', 'fact_check'),
  ('一般行政', NULL, 5, '一般行政程序', 'folder');
