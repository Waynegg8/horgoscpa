...
### 2. 工時管理系統
**檔案**: `timesheet.html`, API 端點內建於 `src/index.js`  
**功能**:
- 每日工時記錄
- 加班時數計算
- 請假管理
...
### 3. 客戶管理系統
**檔案**: `settings.html` (客戶管理標籤), `src/clients.js`  
**功能**:
- 客戶基本資料 CRUD
- 客戶服務配置
- 服務排程管理
...
- `client_service_schedules` - 服務排程（舊）
- `client_interactions` - 客戶互動記錄

### 4. 任務管理系統
**檔案**: `tasks.html`, `multi-stage-tasks.html`, `recurring-tasks.html`  
...
### 6. SOP 知識管理
**檔案**: `sop.html`, `knowledge.html`, `src/sop.js`  
**功能**:
- SOP 文件管理
- 版本控制
- 分類管理
...
- `sops` - SOP 文件
- `sop_versions` - SOP 版本記錄

### 7. 報表系統
**檔案**: `reports.html`, `src/reports.js`  
**功能**:
- 年假報表
- 工時分析報表
- 樞紐分析報表
...
### 8. 內容管理系統 (CMS)
**檔案**: `content-editor.html`, `blog.html`, `resources.html`, `src/cms.js`  
**功能**:
- 部落格文章管理
- 資源文件管理
- 媒體庫管理
